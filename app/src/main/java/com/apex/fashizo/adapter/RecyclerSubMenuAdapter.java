...
public class RecyclerSubMenuAdapter extends RecyclerView.Adapter<RecyclerSubMenuAdapter.RecyclerViewHolder> {
    ...
    public RecyclerSubMenuAdapter(String type, ArrayList<CategoryBeans> recyclerDataArrayList, CanvasActivity mainActivity) {
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Inflate Layout
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.category_itemmenu, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        ...
        holder.menuName.setImageDrawable(mcontext.getResources().getDrawable(recyclerData.getImages()));
    ...
    private void changeList(@NonNull RecyclerViewHolder holder,String id){
        ...
        int indexKey = Integer.parseInt(id)-1;
        CategoryBeans recyclerData = recyclerDataArrayList.get(indexKey);
        mcontext.ChangeSubMenuSelected(type,recyclerData.getImages());
    ...
    public class RecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView menuName;
        private LinearLayout layout;
        public RecyclerViewHolder(@NonNull View itemView) {
            super(itemView);
            menuName = itemView.findViewById(R.id.image);
